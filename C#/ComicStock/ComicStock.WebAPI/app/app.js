var squareEyes = angular.module('squareEyes', ['ngMessages','swxSessionStorage', 'ngRoute', 'supplierModule','creatorModule', 'voucherModule','angularModalService','creatorRoleModule', 'dashboardModule'])
