...
<title>Square Eyes Comic Emporium - Catalogue</title>
...
<div class="container">
        <%--<%--%>
            <%--if(Integer.parseInt(request.getParameter("displaySize")) <= 0)--%>
            <%--{--%>
        ...
        <button class="btn btn-default dropdown-toggle dropdown pull-right" type="button" data-toggle="dropdown">Product Filter
    ...
    <div class="row">
        ...
        <div class="text-center">
            <ul class="pagination">
                ...
                <c:if test="${(page-2) > 0}">
                <li class="page-item"><a href="?page=${page-2}&filter=${filter}"><c:out value="${page-2}"/></c:if></a></li>
                <c:if test="${(page-1) > 0}">
                <li class="page-item"><a href="?page=${page-1}&filter=${filter}"><c:out value="${page-1}"/></c:if></a></li>
                <li class="page-item active">
                    <a class="page-link" href="#">${page}<span class="sr-only">${page}</span></a>
                </li>
                <li class="page-item"><a href="?page=${page+1}&filter=${filter}">${page+1}</a></li>
                <li class="page-item"><a href="?page=${page+2}&filter=${filter}">${page+2}</a></li>
                <li class="page-item">
